...
import { useProFeatures, showUpgradePrompt } from '../utils/proFeatures';
...
const DashboardScreen: React.FC<DashboardScreenProps> = ({ navigation }) => {
  const { habits, settings, updateSettings } = useHabitStore();
  ...
  const { isProUser, canAccessAnalytics, canAddUnlimitedHabits, maxHabitsForFree } = useProFeatures();
  

  
  // Memoize date string to prevent recreation on every render
