// Habit Hero Production Backend API
// Deploy this to any hosting service (Railway, Heroku, etc.)
...
app.get('/health', (req, res) => {
  res.json({ 
    ...
    message: 'Habit Hero Backend API is running'
  });
});
...
app.listen(PORT, () => {
  ...
  console.log(`🔐 Receipt validation: http://localhost:${PORT}/validate-receipt`);
  console.log(`📊 Subscription status: http://localhost:${PORT}/subscription-status`);
});
